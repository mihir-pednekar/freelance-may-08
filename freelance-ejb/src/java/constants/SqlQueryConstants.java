...
public class SqlQueryConstants {
    ...
    public static final String DELETE_JOBAPPS_BY_JOBID="DELETE FROM Jobapps j WHERE j.jobid = :jobid";
    ...
    public static final String UPDATE_JOBS_BY_FREELANCE_ID="UPDATE Jobs j SET j.acceptedby = :fid, j.jobstatus = :status WHERE j.jobid = :jobid ";
